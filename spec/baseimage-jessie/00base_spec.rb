...
describe 'minimum2scp/baseimage-jessie' do
  context 'with env [APT_LINE=keep]' do
    ...
    describe file('/etc/apt/sources.list') do
      ...
      ## stable
      its(:content) { should match apt_line_re[true, 'deb',     'http://httpredir.debian.org/debian/', 'jessie',         'main', 'contrib', 'non-free'] }
      its(:content) { should match apt_line_re[true, 'deb-src', 'http://httpredir.debian.org/debian/', 'jessie',         'main', 'contrib', 'non-free'] }
      ...
      its(:content) { should match apt_line_re[true, 'deb',     'http://httpredir.debian.org/debian/', 'jessie-updates', 'main', 'contrib', 'non-free'] }
      its(:content) { should match apt_line_re[true, 'deb-src', 'http://httpredir.debian.org/debian/', 'jessie-updates', 'main', 'contrib', 'non-free'] }
      ## testing
