...
describe 'minimum2scp/ruby-full' do
  context 'with env [APT_LINE=keep]' do
    ...
    [
      {
        ruby: '3.1.0-preview1',
        desc: 'ruby 3.1.0preview1 (2021-11-09 master 5a3b2e6141) [x86_64-linux]',
        rubygems_version: '3.3.0.dev',
        gems: [
          {name: 'bundler', version: 'default: 2.3.0.dev, 1.17.3'},
          {name: 'pry'}
        ],
      ...
      },
      {
        ...
        gems: [
          {name: 'bundler', version: 'default: 2.2.33, 1.17.3'},
          {name: 'pry'}
        ],
        openssl_version: '1.1.1'
      },
