...
ii   libcurl3                7.52.1-5+deb9u14                   amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.52.1-5+deb9u14                   amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
