...
ii   vim-common              2:8.0.0197-4+deb9u2             all    Vi IMproved - Common files
ii   vim-tiny                2:8.0.0197-4+deb9u2             amd64  Vi IMproved - enhanced vi editor - compact version
ii   whiptail                0.52.19-1+b1                    amd64  Displays user-friendly dialog boxes from shell scripts
ii   xxd                     2:8.0.0197-4+deb9u2             amd64  tool to make (or reverse) a hex dump
