...
ii   curl                    7.52.1-5+deb9u11                   amd64  command line tool for transferring data with URL syntax
...
ii   libcurl3                7.52.1-5+deb9u11                   amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.52.1-5+deb9u11                   amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii   libpython2.7-minimal    2.7.13-2+deb9u4                    amd64  Minimal subset of the Python language (version 2.7)
ii   libpython2.7-stdlib     2.7.13-2+deb9u4                    amd64  Interactive high-level object-oriented language (standard library, version 2.7)
...
ii   libssl1.0.2             1.0.2u-1~deb9u1                    amd64  Secure Sockets Layer toolkit - shared libraries
