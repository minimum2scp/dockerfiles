...
ii   curl                    7.52.1-5+deb9u10                   amd64  command line tool for transferring data with URL syntax
...
ii   git                     1:2.11.0-3+deb9u6                  amd64  fast, scalable, distributed revision control system
ii   git-man                 1:2.11.0-3+deb9u6                  all    fast, scalable, distributed revision control system (manual pages)
...
ii   libcurl3                7.52.1-5+deb9u10                   amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.52.1-5+deb9u10                   amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
