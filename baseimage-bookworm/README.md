# about minimum2scp/baseimage-bookworm image

 * based on [minimum2scp/debian-bookworm](https://github.com/minimum2scp/dockerfiles/tree/master/debian-bookworm) image
 * Runs [/opt/init-wrapper/sbin/init](https://github.com/minimum2scp/dockerfiles/blob/master/baseimage-bookworm/build/opt/init-wrapper/sbin/init) by default
...
```
docker run -d -p 2222:22 minimum2scp/baseimage-bookworm:latest
```
...
ii   git                      1:2.39.5-0+deb12u3              amd64  fast, scalable, distributed revision control system
ii   git-man                  1:2.39.5-0+deb12u3              all    fast, scalable, distributed revision control system (manual pages)
...
ii   libc-l10n                2.36-9+deb12u14                 all    GNU C Library: localization files
ii   libc6                    2.36-9+deb12u14                 amd64  GNU C Library: Shared libraries
ii   libcap-ng0               0.8.3-1+b3                      amd64  alternate POSIX capabilities library
ii   libcap2                  1:2.66-4+deb12u3+b1             amd64  POSIX 1003.1e capabilities (library)
...
ii   libcurl3-gnutls          7.88.1-10+deb12u15              amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4                 7.88.1-10+deb12u15              amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   libgcrypt20              1.10.1-3+deb12u1                amd64  LGPL Crypto library - runtime library
...
ii   libgnutls30              3.7.9-2+deb12u7                 amd64  GNU TLS library - main runtime library
ii   libgpg-error0            1.46-1                          amd64  GnuPG development runtime library
ii   libgssapi-krb5-2         1.20.1-2+deb12u5                amd64  MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
...
ii   libk5crypto3             1.20.1-2+deb12u5                amd64  MIT Kerberos runtime libraries - Crypto Library
ii   libkeyutils1             1.6.3-2                         amd64  Linux Key Management Utilities (library)
ii   libkrb5-3                1.20.1-2+deb12u5                amd64  MIT Kerberos runtime libraries
ii   libkrb5support0          1.20.1-2+deb12u5                amd64  MIT Kerberos runtime libraries - Support library
...
ii   liblzma5                 5.4.1-1+deb12u2                 amd64  XZ-format compression library
...
ii   libnghttp2-14            1.52.0-1+deb12u3                amd64  library implementing HTTP/2 protocol (shared library)
...
ii   libssl3                  3.0.22-1~deb12u1                amd64  Secure Sockets Layer toolkit - shared libraries
...
ii   libudev1                 252.39-1~deb12u2                amd64  libudev shared library
...
ii   locales                  2.36-9+deb12u14                 all    GNU C Library: National Language (locale) data [support]
...
ii   openssl                  3.0.22-1~deb12u1                amd64  Secure Sockets Layer toolkit - cryptographic utility
...
ii   tzdata                   2026c-0+deb12u1                 all    time zone and daylight-saving time data
...
ii   zsh                      5.9-4+b15                       amd64  shell with lots of features
