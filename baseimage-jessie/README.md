...
ii   curl                    7.38.0-4+deb8u9                   amd64  command line tool for transferring data with URL syntax
...
ii   libcurl3                7.38.0-4+deb8u9                   amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.38.0-4+deb8u9                   amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii   tzdata                  2018c-0+deb8u1                    all    time zone and daylight-saving time data
