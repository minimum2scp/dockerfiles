[![Docker Stars](https://img.shields.io/docker/stars/minimum2scp/baseimage-jessie.svg)]()
[![Docker Pulls](https://img.shields.io/docker/pulls/minimum2scp/baseimage-jessie.svg)]()
[![Docker Build Status](https://img.shields.io/docker/build/minimum2scp/baseimage-jessie.svg)]()
[![Docker Automated Build](https://img.shields.io/docker/automated/minimum2scp/baseimage-jessie.svg)]()
...
ii   openssh-client          1:6.7p1-5+deb8u5                  amd64  secure shell (SSH) client, for secure access to remote machines
ii   openssh-server          1:6.7p1-5+deb8u5                  amd64  secure shell (SSH) server, for secure access from remote machines
ii   openssh-sftp-server     1:6.7p1-5+deb8u5                  amd64  secure shell (SSH) sftp server module, for SFTP access from remote machines
...
ii   tzdata                  2018e-0+deb8u1                    all    time zone and daylight-saving time data
