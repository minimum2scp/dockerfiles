...
```
% docker run --rm minimum2scp/debian-jessie:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151101-21800-16b7le4.out
% docker run --rm minimum2scp/baseimage-jessie:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151101-21800-zrka6n.out
% diff -u /tmp/docker-diff.20151101-21800-16b7le4.out /tmp/docker-diff.20151101-21800-zrka6n.out
--- /tmp/docker-diff.20151101-21800-16b7le4.out	2015-11-01 01:40:19.773155359 +0900
+++ /tmp/docker-diff.20151101-21800-zrka6n.out	2015-11-01 01:40:21.037161182 +0900
@@ -9,8 +9,12 @@
...
+ii  libgssapi-krb5-2:amd64          1.12.1+dfsg-19       amd64                MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
...
+ii  libldap-2.4-2:amd64             2.4.40+dfsg-1+deb8u1 amd64                OpenLDAP libraries
...
+ii  libp11-kit0:amd64               0.20.7-1             amd64                Library for loading and coordinating access to PKCS#11 modules - run
 ...
 ii  libpcre3:amd64                  2:8.35-3.3           amd64                Perl 5 Compatible Regular Expression Library - runtime files
...
+ii  libsasl2-2:amd64                2.1.26.dfsg1-13+deb8 amd64                Cyrus SASL - authentication abstraction library
+ii  libsasl2-modules-db:amd64       2.1.26.dfsg1-13+deb8 amd64                Cyrus SASL - pluggable authentication modules (DB)
...
+ii  openssh-sftp-server             1:6.7p1-5            amd64                secure shell (SSH) sftp server module, for SFTP access from remote m
...
+ii  unzip                           6.0-16+deb8u1        amd64                De-archiver for .zip files
