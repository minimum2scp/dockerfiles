...
```
% docker run --rm minimum2scp/debian-jessie:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151011-3646-4inib9.out
% docker run --rm minimum2scp/baseimage-jessie:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151011-3646-16674qa.out
% diff -u /tmp/docker-diff.20151011-3646-4inib9.out /tmp/docker-diff.20151011-3646-16674qa.out
--- /tmp/docker-diff.20151011-3646-4inib9.out	2015-10-11 00:29:55.382745771 +0900
+++ /tmp/docker-diff.20151011-3646-16674qa.out	2015-10-11 00:29:56.622748349 +0900
@@ -9,8 +9,12 @@
