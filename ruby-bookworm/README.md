# about minimum2scp/ruby-bookworm image

 * based on minimum2scp/baseimage-bookworm (see https://github.com/minimum2scp/dockerfiles/tree/master/baseimage-bookworm)
...
```
docker run -d minimum2scp/ruby-bookworm
```
