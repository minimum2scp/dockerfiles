...
ii   libpython3.9-minimal    3.9.2-1+deb11u1                     amd64  Minimal subset of the Python language (version 3.9)
ii   libpython3.9-stdlib     3.9.2-1+deb11u1                     amd64  Interactive high-level object-oriented language (standard library, version 3.9)
...
ii   python3.9               3.9.2-1+deb11u1                     amd64  Interactive high-level object-oriented language (version 3.9)
ii   python3.9-minimal       3.9.2-1+deb11u1                     amd64  Minimal subset of the Python language (version 3.9)
