...
ii   libcurl3-gnutls         7.74.0-1.3+deb11u10             amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4                7.74.0-1.3+deb11u10             amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   openssh-client          1:8.4p1-5+deb11u2               amd64  secure shell (SSH) client, for secure access to remote machines
ii   openssh-server          1:8.4p1-5+deb11u2               amd64  secure shell (SSH) server, for secure access from remote machines
ii   openssh-sftp-server     1:8.4p1-5+deb11u2               amd64  secure shell (SSH) sftp server module, for SFTP access from remote machines
