# about minimum2scp/debian-trixie image

 * Debian trixie (13.x) amd64
 * Almost same as debian:trixie image ([semi official debian image](https://registry.hub.docker.com/_/debian/))

## build minimum2scp/debian-trixie image

Run following commands on your Debian (requires debootstrap)

```
$ git clone https://github.com/minimum2scp/dockerfiles.git
$ cd dockerfiles/debian-trixie
$ rake mkimage TAG=minimum2scp/debian-trixie:latest
```
