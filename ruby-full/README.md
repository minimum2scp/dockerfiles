[![Docker Stars](https://img.shields.io/docker/stars/minimum2scp/ruby-full.svg)]()
 ...
 * ruby ruby ruby 2.2.9, ruby 2.3.6, ruby 2.4.3, ruby 2.5.0-rc1 is installed by rbenv
 * ruby 2.3.5 is installed by debian package
...
ruby 2.3.5p376 (2017-09-14) [x86_64-linux-gnu]
```
