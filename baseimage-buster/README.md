...
ii   libcurl3-gnutls         7.64.0-4+deb10u8             amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4                7.64.0-4+deb10u8             amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
