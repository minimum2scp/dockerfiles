...
ii   git                     1:1.7.10.4-1+wheezy2       amd64  fast, scalable, distributed revision control system                     
ii   git-man                 1:1.7.10.4-1+wheezy2       all    fast, scalable, distributed revision control system (manual pages)      
...
ii   libk5crypto3            1.10.1+dfsg-5+deb7u6       amd64  MIT Kerberos runtime libraries - Crypto Library                         
ii   libkeyutils1            1.5.5-3+deb7u1             amd64  Linux Key Management Utilities (library)                                
ii   libkrb5-3               1.10.1+dfsg-5+deb7u6       amd64  MIT Kerberos runtime libraries                                          
ii   libkrb5support0         1.10.1+dfsg-5+deb7u6       amd64  MIT Kerberos runtime libraries - Support library                        
...
ii   librtmp0                2.4+20111222.git4e06e21-1  amd64  toolkit for RTMP streams (shared library)                               
