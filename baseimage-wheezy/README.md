...
```
% docker run --rm minimum2scp/debian-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151029-7011-1jahn06.out
% docker run --rm minimum2scp/baseimage-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151029-7011-8x5ugb.out
% diff -u /tmp/docker-diff.20151029-7011-1jahn06.out /tmp/docker-diff.20151029-7011-8x5ugb.out
--- /tmp/docker-diff.20151029-7011-1jahn06.out	2015-10-29 01:50:11.182094202 +0900
+++ /tmp/docker-diff.20151029-7011-8x5ugb.out	2015-10-29 01:50:12.142097959 +0900
@@ -3,12 +3,18 @@
...
+ii  unzip                           6.0-8+deb7u3         amd64                De-archiver for .zip files
