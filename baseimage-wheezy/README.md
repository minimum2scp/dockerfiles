...
```
% docker run --rm minimum2scp/debian-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151110-18539-1ghoexk.out
% docker run --rm minimum2scp/baseimage-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151110-18539-1bi0e6f.out
% diff -u /tmp/docker-diff.20151110-18539-1ghoexk.out /tmp/docker-diff.20151110-18539-1bi0e6f.out
--- /tmp/docker-diff.20151110-18539-1ghoexk.out	2015-11-10 00:15:32.690279159 +0900
+++ /tmp/docker-diff.20151110-18539-1bi0e6f.out	2015-11-10 00:15:34.154286926 +0900
@@ -3,12 +3,18 @@
...
+ii  libcurl3:amd64                  7.26.0-1+wheezy13    amd64                easy-to-use client-side URL transfer library (OpenSSL flavour)
+ii  libcurl3-gnutls:amd64           7.26.0-1+wheezy13    amd64                easy-to-use client-side URL transfer library (GnuTLS flavour)
...
+ii  libexpat1:amd64                 2.1.0-1+deb7u2       amd64                XML parsing C library - runtime library
...
+ii  libgssapi-krb5-2:amd64          1.10.1+dfsg-5+deb7u4 amd64                MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
+ii  libidn11:amd64                  1.25-2               amd64                GNU Libidn library, implementation of IETF IDN specifications
+ii  libk5crypto3:amd64              1.10.1+dfsg-5+deb7u4 amd64                MIT Kerberos runtime libraries - Crypto Library
+ii  libkeyutils1:amd64              1.5.5-3+deb7u1       amd64                Linux Key Management Utilities (library)
+ii  libkrb5-3:amd64                 1.10.1+dfsg-5+deb7u4 amd64                MIT Kerberos runtime libraries
+ii  libkrb5support0:amd64           1.10.1+dfsg-5+deb7u4 amd64                MIT Kerberos runtime libraries - Support library
...
+ii  libp11-kit0:amd64               0.12-3               amd64                Library for loading and coordinating access to PKCS#11 modules - run
...
+ii  librtmp0:amd64                  2.4+20111222.git4e06 amd64                toolkit for RTMP streams (shared library)
+ii  libsasl2-2:amd64                2.1.25.dfsg1-6+deb7u amd64                Cyrus SASL - authentication abstraction library
...
+ii  locales                         2.13-38+deb7u8       all                  Embedded GNU C Library: National Language (locale) data [support]
...
+ii  sudo                            1.8.5p2-1+nmu3       amd64                Provide limited super user privileges to specific users
...
+ii  unzip                           6.0-8+deb7u4         amd64                De-archiver for .zip files
