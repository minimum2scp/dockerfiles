...
```
% docker run --rm minimum2scp/debian-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151102-17019-19xd1rm.out
% docker run --rm minimum2scp/baseimage-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151102-17019-pckx3c.out
% diff -u /tmp/docker-diff.20151102-17019-19xd1rm.out /tmp/docker-diff.20151102-17019-pckx3c.out
--- /tmp/docker-diff.20151102-17019-19xd1rm.out	2015-11-02 00:12:05.476413423 +0900
+++ /tmp/docker-diff.20151102-17019-pckx3c.out	2015-11-02 00:12:06.468417853 +0900
@@ -3,12 +3,18 @@
