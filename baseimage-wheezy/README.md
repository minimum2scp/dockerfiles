...
ii   curl                    7.26.0-1+wheezy25                 amd64  command line tool for transferring data with URL syntax
...
ii   libcurl3                7.26.0-1+wheezy25                 amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.26.0-1+wheezy25                 amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
