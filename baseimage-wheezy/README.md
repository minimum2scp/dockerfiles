...
ii   curl                    7.26.0-1+wheezy25+deb7u1          amd64  command line tool for transferring data with URL syntax
...
ii   git                     1:1.7.10.4-1+wheezy6              amd64  fast, scalable, distributed revision control system
ii   git-man                 1:1.7.10.4-1+wheezy6              all    fast, scalable, distributed revision control system (manual pages)
...
ii   libcurl3                7.26.0-1+wheezy25+deb7u1          amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.26.0-1+wheezy25+deb7u1          amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii   libssl1.0.0             1.0.1t-1+deb7u4                   amd64  SSL shared libraries
...
ii   zsh                     4.3.17-1+deb7u2                   amd64  shell with lots of features
```
