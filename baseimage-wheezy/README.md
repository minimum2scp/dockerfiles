...
```
% docker run --rm minimum2scp/debian-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151124-18508-ffi3h0.out
% docker run --rm minimum2scp/baseimage-wheezy:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151124-18508-f2m94.out
% diff -u /tmp/docker-diff.20151124-18508-ffi3h0.out /tmp/docker-diff.20151124-18508-f2m94.out
--- /tmp/docker-diff.20151124-18508-ffi3h0.out	2015-11-24 00:20:14.122616525 +0900
+++ /tmp/docker-diff.20151124-18508-f2m94.out	2015-11-24 00:20:15.538616269 +0900
@@ -3,12 +3,18 @@
...
+ii  libgssapi-krb5-2:amd64          1.10.1+dfsg-5+deb7u6 amd64                MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
+ii  libidn11:amd64                  1.25-2               amd64                GNU Libidn library, implementation of IETF IDN specifications
+ii  libk5crypto3:amd64              1.10.1+dfsg-5+deb7u6 amd64                MIT Kerberos runtime libraries - Crypto Library
+ii  libkeyutils1:amd64              1.5.5-3+deb7u1       amd64                Linux Key Management Utilities (library)
+ii  libkrb5-3:amd64                 1.10.1+dfsg-5+deb7u6 amd64                MIT Kerberos runtime libraries
+ii  libkrb5support0:amd64           1.10.1+dfsg-5+deb7u6 amd64                MIT Kerberos runtime libraries - Support library
