...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141216-32088-579xon.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141216-32088-wva5zh.out
% diff -u /tmp/docker-diff.20141216-32088-579xon.out /tmp/docker-diff.20141216-32088-wva5zh.out
--- /tmp/docker-diff.20141216-32088-579xon.out	2014-12-16 03:26:45.960586972 +0900
+++ /tmp/docker-diff.20141216-32088-wva5zh.out	2014-12-16 03:26:46.564575824 +0900
@@ -6,11 +6,16 @@
