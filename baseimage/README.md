...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151209-23314-190562y.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151209-23314-1eo7vy0.out
% diff -u /tmp/docker-diff.20151209-23314-190562y.out /tmp/docker-diff.20151209-23314-1eo7vy0.out
--- /tmp/docker-diff.20151209-23314-190562y.out	2015-12-09 00:03:56.371738658 +0900
+++ /tmp/docker-diff.20151209-23314-1eo7vy0.out	2015-12-09 00:03:57.983824288 +0900
@@ -8,8 +8,12 @@
