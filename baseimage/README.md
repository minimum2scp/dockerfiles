...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150828-25965-1j83m19.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150828-25965-1edkwh0.out
% diff -u /tmp/docker-diff.20150828-25965-1j83m19.out /tmp/docker-diff.20150828-25965-1edkwh0.out
--- /tmp/docker-diff.20150828-25965-1j83m19.out	2015-08-28 00:13:25.250349587 +0900
+++ /tmp/docker-diff.20150828-25965-1edkwh0.out	2015-08-28 00:13:26.454346614 +0900
@@ -8,8 +8,12 @@
