...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141117-20750-yhnfcu.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141117-20750-17pp707.out
% diff -u /tmp/docker-diff.20141117-20750-yhnfcu.out /tmp/docker-diff.20141117-20750-17pp707.out
--- /tmp/docker-diff.20141117-20750-yhnfcu.out	2014-11-17 14:00:46.159563676 +0900
+++ /tmp/docker-diff.20141117-20750-17pp707.out	2014-11-17 14:00:46.779559125 +0900
@@ -6,11 +6,16 @@
