...
ii   curl                         8.3.0-1                         amd64  command line tool for transferring data with URL syntax
...
ii   libc-bin                     2.37-11                         amd64  GNU C Library: Binaries
ii   libc-l10n                    2.37-11                         all    GNU C Library: localization files
ii   libc6                        2.37-11                         amd64  GNU C Library: Shared libraries
...
ii   libsystemd0                  254.4-1                         amd64  systemd utility library
...
ii   libudev1                     254.4-1                         amd64  libudev shared library
...
ii   locales                      2.37-11                         all    GNU C Library: National Language (locale) data [support]
...
ii   systemd-standalone-sysusers  254.4-1                         amd64  standalone sysusers binary for use in non-systemd systems
