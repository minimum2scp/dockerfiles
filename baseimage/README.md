...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150811-25111-1bliyht.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150811-25111-13chrgm.out
% diff -u /tmp/docker-diff.20150811-25111-1bliyht.out /tmp/docker-diff.20150811-25111-13chrgm.out
--- /tmp/docker-diff.20150811-25111-1bliyht.out	2015-08-11 00:27:00.118398638 +0900
+++ /tmp/docker-diff.20150811-25111-13chrgm.out	2015-08-11 00:27:01.314393490 +0900
@@ -8,8 +8,12 @@
