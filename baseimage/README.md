...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151015-23630-114u5tc.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151015-23630-vxjbpo.out
% diff -u /tmp/docker-diff.20151015-23630-114u5tc.out /tmp/docker-diff.20151015-23630-vxjbpo.out
--- /tmp/docker-diff.20151015-23630-114u5tc.out	2015-10-15 00:08:38.732714981 +0900
+++ /tmp/docker-diff.20151015-23630-vxjbpo.out	2015-10-15 00:08:39.848730214 +0900
@@ -8,8 +8,12 @@
