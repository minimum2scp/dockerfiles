...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150311-26256-yn5dnu.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150311-26256-mlb3fu.out
% diff -u /tmp/docker-diff.20150311-26256-yn5dnu.out /tmp/docker-diff.20150311-26256-mlb3fu.out
--- /tmp/docker-diff.20150311-26256-yn5dnu.out	2015-03-11 01:01:36.732816723 +0900
+++ /tmp/docker-diff.20150311-26256-mlb3fu.out	2015-03-11 01:01:37.292811744 +0900
@@ -9,8 +9,12 @@
