...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150331-23112-1x7177s.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150331-23112-ljkr4l.out
% diff -u /tmp/docker-diff.20150331-23112-1x7177s.out /tmp/docker-diff.20150331-23112-ljkr4l.out
--- /tmp/docker-diff.20150331-23112-1x7177s.out	2015-03-31 00:27:14.847618926 +0900
+++ /tmp/docker-diff.20150331-23112-ljkr4l.out	2015-03-31 00:27:15.507613479 +0900
@@ -9,8 +9,12 @@
