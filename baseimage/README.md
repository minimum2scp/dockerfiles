...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150503-3364-1mgveyr.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150503-3364-mx09p1.out
% diff -u /tmp/docker-diff.20150503-3364-1mgveyr.out /tmp/docker-diff.20150503-3364-mx09p1.out
--- /tmp/docker-diff.20150503-3364-1mgveyr.out	2015-05-03 00:22:05.853161229 +0900
+++ /tmp/docker-diff.20150503-3364-mx09p1.out	2015-05-03 00:22:06.373155810 +0900
@@ -9,8 +9,12 @@
