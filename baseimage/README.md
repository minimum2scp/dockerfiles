...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141230-22337-1lx7dxp.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141230-22337-1kjomc3.out
% diff -u /tmp/docker-diff.20141230-22337-1lx7dxp.out /tmp/docker-diff.20141230-22337-1kjomc3.out
--- /tmp/docker-diff.20141230-22337-1lx7dxp.out	2014-12-30 00:45:12.311525159 +0900
+++ /tmp/docker-diff.20141230-22337-1kjomc3.out	2014-12-30 00:45:12.927523376 +0900
@@ -6,11 +6,16 @@
...
+ii  perl-modules             5.20.1-4          all               Core Perl modules
