...
ii   gcc-10-base             10.2.0-16                       amd64  GCC, the GNU Compiler Collection (base package)
...
ii   libapt-pkg6.0           2.1.11                          amd64  package management runtime library
...
ii   libblkid1               2.36-3+b2                       amd64  block device ID library
...
ii   libgcc-s1               10.2.0-16                       amd64  GCC support library
...
ii   libldap-2.4-2           2.4.55+dfsg-1+b1                amd64  OpenLDAP libraries
...
ii   libmount1               2.36-3+b2                       amd64  device mounting library
...
ii   libperl5.32             5.32.0-4                        amd64  shared Perl library
...
ii   libsmartcols1           2.36-3+b2                       amd64  smart column output alignment library
...
ii   libstdc++6              10.2.0-16                       amd64  GNU Standard C++ Library v3
...
ii   perl                    5.32.0-4                        amd64  Larry Wall's Practical Extraction and Report Language
ii   perl-base               5.32.0-4                        amd64  minimal Perl system
ii   perl-modules-5.32       5.32.0-4                        all    Core Perl modules
...
ii   util-linux              2.36-3+b2                       amd64  miscellaneous system utilities
