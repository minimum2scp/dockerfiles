...
ii   bsdextrautils            2.37.3-1                           amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                 1:2.37.3-1                         amd64  basic utilities from 4.4BSD-Lite
...
ii   gcc-11-base              11.2.0-14                          amd64  GCC, the GNU Compiler Collection (base package)
...
ii   libblkid1                2.37.3-1                           amd64  block device ID library
ii   libbrotli1               1.0.9-2+b3                         amd64  library implementing brotli encoder and decoder (shared libraries)
ii   libbsd0                  0.11.5-1                           amd64  utility functions from BSD systems - shared library
ii   libbz2-1.0               1.0.8-5                            amd64  high-quality block-sorting file compressor library - runtime
ii   libc-bin                 2.33-4                             amd64  GNU C Library: Binaries
ii   libc-l10n                2.33-4                             all    GNU C Library: localization files
ii   libc6                    2.33-4                             amd64  GNU C Library: Shared libraries
...
ii   libcurl3-gnutls          7.81.0-1                           amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4                 7.81.0-1                           amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   libexpat1                2.4.3-2                            amd64  XML parsing C library - runtime library
...
ii   libmount1                2.37.3-1                           amd64  device mounting library
...
ii   libprocps8               2:3.3.17-6                         amd64  library for accessing process information from /proc
...
ii   libpython3.9-minimal     3.9.10-1                           amd64  Minimal subset of the Python language (version 3.9)
ii   libpython3.9-stdlib      3.9.10-1                           amd64  Interactive high-level object-oriented language (standard library, version 3.9)
...
ii   libsmartcols1            2.37.3-1                           amd64  smart column output alignment library
ii   libsqlite3-0             3.37.2-2                           amd64  SQLite 3 shared library
...
ii   libstdc++6               11.2.0-14                          amd64  GNU Standard C++ Library v3
ii   libsystemd0              250.3-1                            amd64  systemd utility library
...
ii   libudev1                 250.3-1                            amd64  libudev shared library
ii   libunistring2            0.9.10-6                           amd64  Unicode string library for C
ii   libuuid1                 2.37.3-1                           amd64  Universally Unique ID library
...
ii   locales                  2.33-4                             all    GNU C Library: National Language (locale) data [support]
...
ii   mount                    2.37.3-1                           amd64  tools for mounting and manipulating filesystems
...
ii   procps                   2:3.3.17-6                         amd64  /proc file system utilities
...
ii   util-linux               2.37.3-1                           amd64  miscellaneous system utilities
