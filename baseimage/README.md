...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150117-16227-1my2xe9.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150117-16227-19xo8xe.out
% diff -u /tmp/docker-diff.20150117-16227-1my2xe9.out /tmp/docker-diff.20150117-16227-19xo8xe.out
--- /tmp/docker-diff.20150117-16227-1my2xe9.out	2015-01-17 01:47:29.500636821 +0900
+++ /tmp/docker-diff.20150117-16227-19xo8xe.out	2015-01-17 01:47:30.156627296 +0900
@@ -6,11 +6,16 @@
