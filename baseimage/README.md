...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150923-28531-f5qw9m.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150923-28531-8g2lml.out
% diff -u /tmp/docker-diff.20150923-28531-f5qw9m.out /tmp/docker-diff.20150923-28531-8g2lml.out
--- /tmp/docker-diff.20150923-28531-f5qw9m.out	2015-09-23 00:06:31.624322060 +0900
+++ /tmp/docker-diff.20150923-28531-8g2lml.out	2015-09-23 00:06:32.944366343 +0900
@@ -8,8 +8,12 @@
