...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150324-3213-1vldbn3.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150324-3213-1t4yajv.out
% diff -u /tmp/docker-diff.20150324-3213-1vldbn3.out /tmp/docker-diff.20150324-3213-1t4yajv.out
--- /tmp/docker-diff.20150324-3213-1vldbn3.out	2015-03-24 00:15:03.986317166 +0900
+++ /tmp/docker-diff.20150324-3213-1t4yajv.out	2015-03-24 00:15:04.610312194 +0900
@@ -9,8 +9,12 @@
