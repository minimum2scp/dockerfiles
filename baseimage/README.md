...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150909-23390-125vvnw.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150909-23390-1omhe9l.out
% diff -u /tmp/docker-diff.20150909-23390-125vvnw.out /tmp/docker-diff.20150909-23390-1omhe9l.out
--- /tmp/docker-diff.20150909-23390-125vvnw.out	2015-09-09 00:11:51.845834184 +0900
+++ /tmp/docker-diff.20150909-23390-1omhe9l.out	2015-09-09 00:11:53.573836857 +0900
@@ -8,8 +8,12 @@
...
+ii  man-db                   2.7.2-1           amd64             on-line manual pager
