...
ii   bsdextrautils                2.39.3-9                        amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.39.3-9                      amd64  basic utilities from 4.4BSD-Lite
...
ii   cron                         3.0pl1-186+b1                   amd64  process scheduling daemon
ii   cron-daemon-common           3.0pl1-186                      all    process scheduling daemon's configuration files
...
ii   e2fsprogs                    1.47.0-2.3                      amd64  ext2/ext3/ext4 file system utilities
...
ii   libblkid1                    2.39.3-9                        amd64  block device ID library
...
ii   libcom-err2t64               1.47.0-2.3                      amd64  common error description library
...
ii   libext2fs2t64                1.47.0-2.3                      amd64  ext2/ext3/ext4 file system libraries
...
ii   libgdbm-compat4              1.23-5+b1                       amd64  GNU dbm database routines (legacy support runtime version) 
ii   libgdbm6                     1.23-5+b1                       amd64  GNU dbm database routines (runtime version) 
...
ii   libmount1                    2.39.3-9                        amd64  device mounting library
...
ii   libsmartcols1                2.39.3-9                        amd64  smart column output alignment library
ii   libsqlite3-0                 3.45.1-1                        amd64  SQLite 3 shared library
ii   libss2t64                    1.47.0-2.3                      amd64  command-line interface parsing library
...
ii   libuuid1                     2.39.3-9                        amd64  Universally Unique ID library
...
ii   locales                      2.37-15.1                       all    GNU C Library: National Language (locale) data [support]
ii   login                        1:4.13+dfsg1-4                  amd64  system login tools
ii   logsave                      1.47.0-2.3                      amd64  save the output of a command in a log file
...
ii   mount                        2.39.3-9                        amd64  tools for mounting and manipulating filesystems
...
ii   util-linux                   2.39.3-9                        amd64  miscellaneous system utilities
