...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150929-22112-6mmaaj.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150929-22112-1n1pcjl.out
% diff -u /tmp/docker-diff.20150929-22112-6mmaaj.out /tmp/docker-diff.20150929-22112-1n1pcjl.out
--- /tmp/docker-diff.20150929-22112-6mmaaj.out	2015-09-29 00:54:20.496035696 +0900
+++ /tmp/docker-diff.20150929-22112-1n1pcjl.out	2015-09-29 00:54:21.608039506 +0900
@@ -8,8 +8,12 @@
