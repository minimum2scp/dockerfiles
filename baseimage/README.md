...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150604-31216-14my6sh.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150604-31216-p3z8r9.out
% diff -u /tmp/docker-diff.20150604-31216-14my6sh.out /tmp/docker-diff.20150604-31216-p3z8r9.out
--- /tmp/docker-diff.20150604-31216-14my6sh.out	2015-06-04 01:10:25.651636585 +0900
+++ /tmp/docker-diff.20150604-31216-p3z8r9.out	2015-06-04 01:10:27.147632178 +0900
@@ -8,8 +8,12 @@
