...
ii   curl                    7.52.1-4                        amd64  command line tool for transferring data with URL syntax
...
ii   gcc-6-base              6.3.0-13.0~reproducible1        amd64  GCC, the GNU Compiler Collection (base package)
...
ii   libcurl3                7.52.1-4                        amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
ii   libcurl3-gnutls         7.52.1-4                        amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii   libgcc1                 1:6.3.0-13.0~reproducible1      amd64  GCC support library
...
ii   libnghttp2-14           1.21.1-1                        amd64  library implementing HTTP/2 protocol (shared library)
...
ii   libstdc++6              6.3.0-13.0~reproducible1        amd64  GNU Standard C++ Library v3
...
ii   vim-common              2:8.0.0197-3                    all    Vi IMproved - Common files
ii   vim-tiny                2:8.0.0197-3                    amd64  Vi IMproved - enhanced vi editor - compact version
