...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150428-8163-1frj018.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150428-8163-xehrwz.out
% diff -u /tmp/docker-diff.20150428-8163-1frj018.out /tmp/docker-diff.20150428-8163-xehrwz.out
--- /tmp/docker-diff.20150428-8163-1frj018.out	2015-04-28 01:11:13.407789396 +0900
+++ /tmp/docker-diff.20150428-8163-xehrwz.out	2015-04-28 01:11:14.027788262 +0900
@@ -9,8 +9,12 @@
