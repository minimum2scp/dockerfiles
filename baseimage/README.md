...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150520-22470-u2bzmg.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150520-22470-1oxex9h.out
% diff -u /tmp/docker-diff.20150520-22470-u2bzmg.out /tmp/docker-diff.20150520-22470-1oxex9h.out
--- /tmp/docker-diff.20150520-22470-u2bzmg.out	2015-05-20 00:13:05.549241657 +0900
+++ /tmp/docker-diff.20150520-22470-1oxex9h.out	2015-05-20 00:13:06.977030558 +0900
@@ -9,8 +9,12 @@
