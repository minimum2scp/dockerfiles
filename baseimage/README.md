...
ii   git                     1:2.31.1-1                      amd64  fast, scalable, distributed revision control system
ii   git-man                 1:2.31.1-1                      all    fast, scalable, distributed revision control system (manual pages)
...
ii   libc-bin                2.31-11                         amd64  GNU C Library: Binaries
ii   libc-l10n               2.31-11                         all    GNU C Library: localization files
ii   libc6                   2.31-11                         amd64  GNU C Library: Shared libraries
...
ii   libgnutls30             3.7.1-4                         amd64  GNU TLS library - main runtime library
...
ii   libsystemd0             247.3-5                         amd64  systemd utility library
...
ii   libudev1                247.3-5                         amd64  libudev shared library
...
ii   locales                 2.31-11                         all    GNU C Library: National Language (locale) data [support]
