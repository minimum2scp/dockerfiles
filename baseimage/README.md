...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150911-29255-26r7om.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150911-29255-16bmkcw.out
% diff -u /tmp/docker-diff.20150911-29255-26r7om.out /tmp/docker-diff.20150911-29255-16bmkcw.out
--- /tmp/docker-diff.20150911-29255-26r7om.out	2015-09-11 00:47:36.060163436 +0900
+++ /tmp/docker-diff.20150911-29255-16bmkcw.out	2015-09-11 00:47:37.596171759 +0900
@@ -8,8 +8,12 @@
...
+ii  libldap-2.4-2:amd64      2.4.42+dfsg-1     amd64             OpenLDAP libraries
