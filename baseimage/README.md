...
ii   bsdextrautils                2.39.3-2                        amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.39.3-2                      amd64  basic utilities from 4.4BSD-Lite
...
ii   gcc-13-base                  13.2.0-8                        amd64  GCC, the GNU Compiler Collection (base package)
...
ii   libbrotli1                   1.1.0-2+b1                      amd64  library implementing brotli encoder and decoder (shared libraries)
...
ii   libc6                        2.37-13                         amd64  GNU C Library: Shared libraries
ii   libcap-ng0                   0.8.3-3                         amd64  alternate POSIX capabilities library
...
ii   libgcc-s1                    13.2.0-8                        amd64  GCC support library
...
ii   libsmartcols1                2.39.3-2                        amd64  smart column output alignment library
...
ii   locales                      2.37-13                         all    GNU C Library: National Language (locale) data [support]
...
ii   rsyslog                      8.2310.0-4                      amd64  reliable system and kernel logging daemon
...
ii   sudo                         1.9.15p2-2                      amd64  Provide limited super user privileges to specific users
ii   systemd-standalone-sysusers  255-1                           amd64  standalone sysusers binary for use in non-systemd systems
