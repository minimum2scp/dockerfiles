...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150609-21705-brqz0z.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150609-21705-18gn63u.out
% diff -u /tmp/docker-diff.20150609-21705-brqz0z.out /tmp/docker-diff.20150609-21705-18gn63u.out
--- /tmp/docker-diff.20150609-21705-brqz0z.out	2015-06-09 00:07:23.880088423 +0900
+++ /tmp/docker-diff.20150609-21705-18gn63u.out	2015-06-09 00:07:25.216186368 +0900
@@ -8,8 +8,12 @@
