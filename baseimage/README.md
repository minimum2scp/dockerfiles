...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151126-19434-1rk5qb6.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151126-19434-vrndnj.out
% diff -u /tmp/docker-diff.20151126-19434-1rk5qb6.out /tmp/docker-diff.20151126-19434-vrndnj.out
--- /tmp/docker-diff.20151126-19434-1rk5qb6.out	2015-11-26 01:15:20.831046244 +0900
+++ /tmp/docker-diff.20151126-19434-vrndnj.out	2015-11-26 01:15:22.675052739 +0900
@@ -8,8 +8,12 @@
...
+ii  etckeeper                       1.18.1               all                  store /etc in git, mercurial, bzr or darcs
 ...
 ii  gcc-5-base:amd64                5.2.1-25             amd64                GCC, the GNU Compiler Collection (base package)
...
+ii  libcurl3-gnutls:amd64           7.45.0-1+b1          amd64                easy-to-use client-side URL transfer library (GnuTLS flavour)
 ...
 ii  libdebconfclient0:amd64         0.197                amd64                Debian Configuration Management System (C-implementation library)
...
+ii  libffi6:amd64                   3.2.1-3              amd64                Foreign Function Interface library runtime
 ii  libgcc1:amd64                   1:5.2.1-25           amd64                GCC support library
...
+ii  libssl1.0.2:amd64               1.0.2d-3             amd64                Secure Sockets Layer toolkit - shared libraries
 ii  libstdc++6:amd64                5.2.1-25             amd64                GNU Standard C++ Library v3
