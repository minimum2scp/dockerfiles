...
ii   apt                          2.9.3                           amd64  commandline package manager
...
ii   bsdextrautils                2.40.1-1                        amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.40.1-1                      amd64  basic utilities from 4.4BSD-Lite
...
ii   e2fsprogs                    1.47.1~rc2-1                    amd64  ext2/ext3/ext4 file system utilities
...
ii   gpgv                         2.2.43-3                        amd64  GNU privacy guard - signature verification tool
...
ii   libapt-pkg6.0t64             2.9.3                           amd64  package management runtime library
...
ii   libblkid1                    2.40.1-1                        amd64  block device ID library
...
ii   libc-l10n                    2.38-11                         all    GNU C Library: localization files
...
ii   libcurl3t64-gnutls           8.7.1-5                         amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4t64                  8.7.1-5                         amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   libedit2                     3.1-20230828-1+b1               amd64  BSD editline and history libraries
...
ii   libext2fs2t64                1.47.1~rc2-1                    amd64  ext2/ext3/ext4 file system libraries
...
ii   libldap-2.5-0                2.5.17+dfsg-1                   amd64  OpenLDAP libraries
...
ii   libmount1                    2.40.1-1                        amd64  device mounting library
...
ii   libperl5.38t64               5.38.2-4                        amd64  shared Perl library
...
ii   libsmartcols1                2.40.1-1                        amd64  smart column output alignment library
ii   libsqlite3-0                 3.45.3-1                        amd64  SQLite 3 shared library
ii   libss2                       1.47.1~rc2-1                    amd64  command-line interface parsing library
ii   libssh2-1t64                 1.11.0-4.1+b2                   amd64  SSH2 client-side library
...
ii   libsystemd0                  256~rc2-1                       amd64  systemd utility library
...
ii   libudev1                     256~rc2-1                       amd64  libudev shared library
ii   libunistring5                1.2-1                           amd64  Unicode string library for C
ii   libuuid1                     2.40.1-1                        amd64  Universally Unique ID library
...
ii   locales                      2.38-11                         all    GNU C Library: National Language (locale) data [support]
ii   login                        1:4.13+dfsg1-4                  amd64  system login tools
ii   logsave                      1.47.1~rc2-1                    amd64  save the output of a command in a log file
...
ii   mount                        2.40.1-1                        amd64  tools for mounting and manipulating filesystems
...
ii   perl                         5.38.2-4                        amd64  Larry Wall's Practical Extraction and Report Language
ii   perl-base                    5.38.2-4                        amd64  minimal Perl system
ii   perl-modules-5.38            5.38.2-4                        all    Core Perl modules
...
ii   systemd-standalone-sysusers  256~rc2-1                       amd64  standalone sysusers binary for use in non-systemd systems
ii   sysv-rc                      3.09-1                          all    System-V-like runlevel change mechanism
ii   sysvinit-core                3.09-1                          amd64  System-V-like init
...
ii   util-linux                   2.40.1-1                        amd64  miscellaneous system utilities
ii   vim-common                   2:9.1.0377-1                    all    Vi IMproved - Common files
ii   vim-tiny                     2:9.1.0377-1                    amd64  Vi IMproved - enhanced vi editor - compact version
