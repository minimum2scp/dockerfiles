...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150521-22703-qkx1i5.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150521-22703-981v0j.out
% diff -u /tmp/docker-diff.20150521-22703-qkx1i5.out /tmp/docker-diff.20150521-22703-981v0j.out
--- /tmp/docker-diff.20150521-22703-qkx1i5.out	2015-05-21 01:52:41.128700218 +0900
+++ /tmp/docker-diff.20150521-22703-981v0j.out	2015-05-21 01:52:42.412657922 +0900
@@ -9,8 +9,12 @@
