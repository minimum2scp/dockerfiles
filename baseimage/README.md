...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151018-25028-1tc9u0k.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151018-25028-1m8345p.out
% diff -u /tmp/docker-diff.20151018-25028-1tc9u0k.out /tmp/docker-diff.20151018-25028-1m8345p.out
--- /tmp/docker-diff.20151018-25028-1tc9u0k.out	2015-10-18 03:58:54.418420055 +0900
+++ /tmp/docker-diff.20151018-25028-1m8345p.out	2015-10-18 03:58:55.750418640 +0900
@@ -8,8 +8,12 @@
