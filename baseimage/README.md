...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141109-20067-1aaxqo8.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141109-20067-n6xzse.out
% diff -u /tmp/docker-diff.20141109-20067-1aaxqo8.out /tmp/docker-diff.20141109-20067-n6xzse.out
--- /tmp/docker-diff.20141109-20067-1aaxqo8.out	2014-11-09 22:42:15.119502236 +0900
+++ /tmp/docker-diff.20141109-20067-n6xzse.out	2014-11-09 22:42:15.767496835 +0900
@@ -6,11 +6,16 @@
...
+ii  libexpat1:amd64          2.1.0-6+b1        amd64             XML parsing C library - runtime library
