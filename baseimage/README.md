...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151121-25135-2z8k9v.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151121-25135-hnn3i2.out
% diff -u /tmp/docker-diff.20151121-25135-2z8k9v.out /tmp/docker-diff.20151121-25135-hnn3i2.out
--- /tmp/docker-diff.20151121-25135-2z8k9v.out	2015-11-21 00:42:34.459981044 +0900
+++ /tmp/docker-diff.20151121-25135-hnn3i2.out	2015-11-21 00:42:36.079961766 +0900
@@ -8,8 +8,12 @@
...
+ii  libp11-kit0:amd64               0.23.1-3             amd64                Library for loading and coordinating access to PKCS#11 modules - run
 ...
 ii  libpcre3:amd64                  2:8.35-7.4           amd64                Perl 5 Compatible Regular Expression Library - runtime files
