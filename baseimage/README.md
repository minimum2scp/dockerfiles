...
ii   bsdutils                1:2.35.2-1                      amd64  basic utilities from 4.4BSD-Lite
...
ii   libblkid1               2.35.2-1                        amd64  block device ID library
...
ii   libmount1               2.35.2-1                        amd64  device mounting library
...
ii   libsmartcols1           2.35.2-1                        amd64  smart column output alignment library
...
ii   libstdc++6              10.1.0-2                        amd64  GNU Standard C++ Library v3
...
ii   libuuid1                2.35.2-1                        amd64  Universally Unique ID library
...
ii   mount                   2.35.2-1                        amd64  tools for mounting and manipulating filesystems
...
ii   ucf                     3.0041                          all    Update Configuration File(s): preserve user changes to config files
ii   unzip                   6.0-25                          amd64  De-archiver for .zip files
ii   util-linux              2.35.2-1                        amd64  miscellaneous system utilities
