...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150603-31530-rt94s0.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150603-31530-124dwk.out
% diff -u /tmp/docker-diff.20150603-31530-rt94s0.out /tmp/docker-diff.20150603-31530-124dwk.out
--- /tmp/docker-diff.20150603-31530-rt94s0.out	2015-06-03 01:52:09.109409613 +0900
+++ /tmp/docker-diff.20150603-31530-124dwk.out	2015-06-03 01:52:10.493412947 +0900
@@ -8,8 +8,12 @@
