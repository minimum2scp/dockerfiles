...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141017-13966-ay3c1.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141017-13966-f2s7cn.out
% diff -u /tmp/docker-diff.20141017-13966-ay3c1.out /tmp/docker-diff.20141017-13966-f2s7cn.out
--- /tmp/docker-diff.20141017-13966-ay3c1.out 2014-10-17 00:09:26.760125938 +0900
+++ /tmp/docker-diff.20141017-13966-f2s7cn.out  2014-10-17 00:09:27.364129583 +0900
@@ -6,11 +6,16 @@
...
+ii  etckeeper                1.14              all               store /etc in git, mercurial, bzr or darcs
 ...
 ii  gcc-4.9-base:amd64       4.9.1-17          amd64             GCC, the GNU Compiler Collection (base package)
...
+ii  libffi6:amd64            3.1-2             amd64             Foreign Function Interface library runtime
 ii  libgcc1:amd64            1:4.9.1-17        amd64             GCC support library
...
+ii  libssl1.0.0:amd64        1.0.1j-1          amd64             Secure Sockets Layer toolkit - shared libraries
 ii  libstdc++6:amd64         4.9.1-17          amd64             GNU Standard C++ Library v3
