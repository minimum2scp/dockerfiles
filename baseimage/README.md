...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151002-19356-1722jlw.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151002-19356-ndhwms.out
% diff -u /tmp/docker-diff.20151002-19356-1722jlw.out /tmp/docker-diff.20151002-19356-ndhwms.out
--- /tmp/docker-diff.20151002-19356-1722jlw.out	2015-10-02 00:15:06.914933008 +0900
+++ /tmp/docker-diff.20151002-19356-ndhwms.out	2015-10-02 00:15:08.038950189 +0900
@@ -8,8 +8,12 @@
...
-ii  gcc-5-base:amd64         5.2.1-18          amd64             GCC, the GNU Compiler Collection (base package)
+ii  gcc-5-base:amd64         5.2.1-19          amd64             GCC, the GNU Compiler Collection (base package)
+ii  git                      1:2.6.0-1         amd64             fast, scalable, distributed revision control system
+ii  git-man                  1:2.6.0-1         all               fast, scalable, distributed revision control system (
...
-ii  libgcc1:amd64            1:5.2.1-18        amd64             GCC support library
+ii  libffi6:amd64            3.2.1-3           amd64             Foreign Function Interface library runtime
+ii  libgcc1:amd64            1:5.2.1-19        amd64             GCC support library
...
-ii  libstdc++6:amd64         5.2.1-18          amd64             GNU Standard C++ Library v3
...
+ii  libstdc++6:amd64         5.2.1-19          amd64             GNU Standard C++ Library v3
