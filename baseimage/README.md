...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150505-4327-1t8192e.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150505-4327-xplg4j.out
% diff -u /tmp/docker-diff.20150505-4327-1t8192e.out /tmp/docker-diff.20150505-4327-xplg4j.out
--- /tmp/docker-diff.20150505-4327-1t8192e.out	2015-05-05 00:14:56.242309922 +0900
+++ /tmp/docker-diff.20150505-4327-xplg4j.out	2015-05-05 00:14:57.782224114 +0900
@@ -9,8 +9,12 @@
