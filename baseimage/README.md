...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150827-26820-twyz4k.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150827-26820-nf76vq.out
% diff -u /tmp/docker-diff.20150827-26820-twyz4k.out /tmp/docker-diff.20150827-26820-nf76vq.out
--- /tmp/docker-diff.20150827-26820-twyz4k.out	2015-08-27 00:03:46.222290135 +0900
+++ /tmp/docker-diff.20150827-26820-nf76vq.out	2015-08-27 00:03:47.750277514 +0900
@@ -8,8 +8,12 @@
