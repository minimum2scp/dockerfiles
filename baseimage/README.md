...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151009-26027-3roiub.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151009-26027-dvka2k.out
% diff -u /tmp/docker-diff.20151009-26027-3roiub.out /tmp/docker-diff.20151009-26027-dvka2k.out
--- /tmp/docker-diff.20151009-26027-3roiub.out	2015-10-09 00:09:36.763666603 +0900
+++ /tmp/docker-diff.20151009-26027-dvka2k.out	2015-10-09 00:09:38.263674986 +0900
@@ -8,8 +8,12 @@
