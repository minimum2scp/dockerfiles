...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150915-24402-z46km4.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150915-24402-8mzgq.out
% diff -u /tmp/docker-diff.20150915-24402-z46km4.out /tmp/docker-diff.20150915-24402-8mzgq.out
--- /tmp/docker-diff.20150915-24402-z46km4.out	2015-09-15 00:27:30.228430629 +0900
+++ /tmp/docker-diff.20150915-24402-8mzgq.out	2015-09-15 00:27:31.404435585 +0900
@@ -8,8 +8,12 @@
