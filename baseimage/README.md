...
ii   bsdextrautils                2.40.1-8.1                      amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.40.1-8.1                    amd64  basic utilities from 4.4BSD-Lite
...
ii   libc-bin                     2.38-12.1                       amd64  GNU C Library: Binaries
ii   libc-l10n                    2.38-12.1                       all    GNU C Library: localization files
ii   libc6                        2.38-12.1                       amd64  GNU C Library: Shared libraries
...
ii   libsmartcols1                2.40.1-8.1                      amd64  smart column output alignment library
...
ii   libsystemd0                  256~rc4-1                       amd64  systemd utility library
...
ii   libudev1                     256~rc4-1                       amd64  libudev shared library
...
ii   locales                      2.38-12.1                       all    GNU C Library: National Language (locale) data [support]
...
ii   systemd-standalone-sysusers  256~rc4-1                       amd64  standalone sysusers binary for use in non-systemd systems
...
ii   util-linux                   2.40.1-8.1                      amd64  miscellaneous system utilities
