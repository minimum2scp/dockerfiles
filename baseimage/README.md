...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150524-24465-1h5lu6c.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150524-24465-pm5hje.out
% diff -u /tmp/docker-diff.20150524-24465-1h5lu6c.out /tmp/docker-diff.20150524-24465-pm5hje.out
--- /tmp/docker-diff.20150524-24465-1h5lu6c.out	2015-05-24 00:34:31.280434285 +0900
+++ /tmp/docker-diff.20150524-24465-pm5hje.out	2015-05-24 00:34:32.700392854 +0900
@@ -9,8 +9,12 @@
