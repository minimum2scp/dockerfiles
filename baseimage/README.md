...
ii   bsdextrautils            2.37.2-6                           amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                 1:2.37.2-6                         amd64  basic utilities from 4.4BSD-Lite
...
ii   libblkid1                2.37.2-6                           amd64  block device ID library
ii   libbrotli1               1.0.9-2+b3                         amd64  library implementing brotli encoder and decoder (shared libraries)
ii   libbsd0                  0.11.4-1                           amd64  utility functions from BSD systems - shared library
ii   libbz2-1.0               1.0.8-5                            amd64  high-quality block-sorting file compressor library - runtime
ii   libc-bin                 2.33-3                             amd64  GNU C Library: Binaries
ii   libc-l10n                2.33-3                             all    GNU C Library: localization files
ii   libc6                    2.33-3                             amd64  GNU C Library: Shared libraries
...
ii   libexpat1                2.4.3-1                            amd64  XML parsing C library - runtime library
...
ii   libmount1                2.37.2-6                           amd64  device mounting library
...
ii   libsmartcols1            2.37.2-6                           amd64  smart column output alignment library
...
ii   libuuid1                 2.37.2-6                           amd64  Universally Unique ID library
...
ii   locales                  2.33-3                             all    GNU C Library: National Language (locale) data [support]
...
ii   util-linux               2.37.2-6                           amd64  miscellaneous system utilities
