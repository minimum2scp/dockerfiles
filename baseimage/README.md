...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150302-20616-voxdjn.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150302-20616-1sra4su.out
% diff -u /tmp/docker-diff.20150302-20616-voxdjn.out /tmp/docker-diff.20150302-20616-1sra4su.out
--- /tmp/docker-diff.20150302-20616-voxdjn.out	2015-03-02 00:32:33.079075732 +0900
+++ /tmp/docker-diff.20150302-20616-1sra4su.out	2015-03-02 00:32:33.691070342 +0900
@@ -6,11 +6,16 @@
