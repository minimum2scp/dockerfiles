...
ii   libc-l10n               2.21-6                        all    GNU C Library: localization files                                              
...
ii   libsqlite3-0            3.10.1-1                      amd64  SQLite 3 shared library                                                        
...
ii   openssh-client          1:7.1p2-1                     amd64  secure shell (SSH) client, for secure access to remote machines                
ii   openssh-server          1:7.1p2-1                     amd64  secure shell (SSH) server, for secure access from remote machines              
ii   openssh-sftp-server     1:7.1p2-1                     amd64  secure shell (SSH) sftp server module, for SFTP access from remote machines    
