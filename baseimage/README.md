...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151007-23871-13fn4i.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151007-23871-1t3xs8l.out
% diff -u /tmp/docker-diff.20151007-23871-13fn4i.out /tmp/docker-diff.20151007-23871-1t3xs8l.out
--- /tmp/docker-diff.20151007-23871-13fn4i.out	2015-10-07 00:13:54.929876027 +0900
+++ /tmp/docker-diff.20151007-23871-1t3xs8l.out	2015-10-07 00:13:56.485866425 +0900
@@ -8,8 +8,12 @@
