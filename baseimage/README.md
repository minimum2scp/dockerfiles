...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150613-22628-hp8l96.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150613-22628-11yveqh.out
% diff -u /tmp/docker-diff.20150613-22628-hp8l96.out /tmp/docker-diff.20150613-22628-11yveqh.out
--- /tmp/docker-diff.20150613-22628-hp8l96.out	2015-06-13 00:11:05.750242930 +0900
+++ /tmp/docker-diff.20150613-22628-11yveqh.out	2015-06-13 00:11:07.218249896 +0900
@@ -8,8 +8,12 @@
...
+ii  curl                     7.42.1-3          amd64             command line tool for transferring data with URL synt
...
+ii  libcurl3-gnutls:amd64    7.42.1-3          amd64             easy-to-use client-side URL transfer library (GnuTLS 
...
+ii  libgnutls-deb0-28:amd64  3.3.15-5          amd64             GNU TLS library - main runtime library
...
+ii  libsasl2-modules-db:amd6 2.1.26.dfsg1-13   amd64             Cyrus SASL - pluggable authentication modules (DB)
 ii  libseccomp2:amd64        2.2.1-1           amd64             high level interface to Linux seccomp filter
...
+ii  libssl1.0.0:amd64        1.0.2b-1          amd64             Secure Sockets Layer toolkit - shared libraries
...
+ii  openssl                  1.0.2b-1          amd64             Secure Sockets Layer toolkit - cryptographic utility
...
-ii  systemd                  220-6             amd64             system and service manager
-ii  systemd-sysv             220-6             amd64             system and service manager - SysV links
...
+ii  ucf                      3.0030            all               Update Configuration File(s): preserve user changes t
 ii  udev                     220-6             amd64             /dev/ and hotplug management daemon
