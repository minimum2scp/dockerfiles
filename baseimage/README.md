...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141109-13865-amgswg.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141109-13865-1k0p7ry.out
% diff -u /tmp/docker-diff.20141109-13865-amgswg.out /tmp/docker-diff.20141109-13865-1k0p7ry.out
--- /tmp/docker-diff.20141109-13865-amgswg.out	2014-11-09 21:26:30.141856927 +0900
+++ /tmp/docker-diff.20141109-13865-1k0p7ry.out	2014-11-09 21:26:30.753851251 +0900
@@ -6,28 +6,37 @@
