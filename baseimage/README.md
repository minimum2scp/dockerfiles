...
ii   bsdextrautils                2.40.2-10                       amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.40.2-10                     amd64  basic utilities from 4.4BSD-Lite
...
ii   libaudit-common              1:4.0.1-3                       all    Dynamic library for security auditing - common files
ii   libaudit1                    1:4.0.1-3                       amd64  Dynamic library for security auditing
ii   libblkid1                    2.40.2-10                       amd64  block device ID library
...
ii   libext2fs2t64                1.47.1-1+b1                     amd64  ext2/ext3/ext4 file system libraries
...
ii   libmount1                    2.40.2-10                       amd64  device mounting library
...
ii   libnewt0.52                  0.52.24-3                       amd64  Not Erik's Windowing Toolkit - text mode windowing with slang
...
ii   libsmartcols1                2.40.2-10                       amd64  smart column output alignment library
...
ii   libuuid1                     2.40.2-10                       amd64  Universally Unique ID library
...
ii   mount                        2.40.2-10                       amd64  tools for mounting and manipulating filesystems
...
ii   util-linux                   2.40.2-10                       amd64  miscellaneous system utilities
...
ii   whiptail                     0.52.24-3                       amd64  Displays user-friendly dialog boxes from shell scripts
...
ii   zstd                         1.5.6+dfsg-1+b1                 amd64  fast lossless compression algorithm -- CLI tool
```
