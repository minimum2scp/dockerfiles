...
ii   libc-bin                 2.37-4                          amd64  GNU C Library: Binaries
ii   libc-l10n                2.37-4                          all    GNU C Library: localization files
ii   libc6                    2.37-4                          amd64  GNU C Library: Shared libraries
...
ii   libp11-kit0              0.25.0-2                        amd64  library for loading and coordinating access to PKCS#11 modules - runtime
...
ii   locales                  2.37-4                          all    GNU C Library: National Language (locale) data [support]
...
ii   rsyslog                  8.2306.0-1                      amd64  reliable system and kernel logging daemon
