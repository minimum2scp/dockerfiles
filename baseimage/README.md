...
ii   bsdutils                1:2.32.1-0.2                 amd64  basic utilities from 4.4BSD-Lite
...
ii   libstdc++6              8.2.0-10                     amd64  GNU Standard C++ Library v3
...
ii   libudev1                239-13                       amd64  libudev shared library
...
ii   mount                   2.32.1-0.2                   amd64  tools for mounting and manipulating filesystems
...
ii   vim-tiny                2:8.1.0320-1+b2              amd64  Vi IMproved - enhanced vi editor - compact version
ii   whiptail                0.52.20-8                    amd64  Displays user-friendly dialog boxes from shell scripts
ii   xxd                     2:8.1.0320-1+b2              amd64  tool to make (or reverse) a hex dump
