...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150213-9133-1b3vbbw.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150213-9133-1tqe8cf.out
% diff -u /tmp/docker-diff.20150213-9133-1b3vbbw.out /tmp/docker-diff.20150213-9133-1tqe8cf.out
--- /tmp/docker-diff.20150213-9133-1b3vbbw.out	2015-02-13 00:19:04.535977030 +0900
+++ /tmp/docker-diff.20150213-9133-1tqe8cf.out	2015-02-13 00:19:05.111970597 +0900
@@ -6,11 +6,16 @@
