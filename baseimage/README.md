...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150517-7612-1igxa6u.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150517-7612-50cyig.out
% diff -u /tmp/docker-diff.20150517-7612-1igxa6u.out /tmp/docker-diff.20150517-7612-50cyig.out
--- /tmp/docker-diff.20150517-7612-1igxa6u.out	2015-05-17 00:17:51.630445173 +0900
+++ /tmp/docker-diff.20150517-7612-50cyig.out	2015-05-17 00:17:53.070435930 +0900
@@ -9,8 +9,12 @@
