...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150818-22997-113yjyu.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150818-22997-1pegmpr.out
% diff -u /tmp/docker-diff.20150818-22997-113yjyu.out /tmp/docker-diff.20150818-22997-1pegmpr.out
--- /tmp/docker-diff.20150818-22997-113yjyu.out	2015-08-18 00:22:33.494488156 +0900
+++ /tmp/docker-diff.20150818-22997-1pegmpr.out	2015-08-18 00:22:35.058473577 +0900
@@ -8,8 +8,12 @@
