...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141214-14436-19pe368.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141214-14436-1181zb4.out
% diff -u /tmp/docker-diff.20141214-14436-19pe368.out /tmp/docker-diff.20141214-14436-1181zb4.out
--- /tmp/docker-diff.20141214-14436-19pe368.out	2014-12-14 00:04:32.486761568 +0900
+++ /tmp/docker-diff.20141214-14436-1181zb4.out	2014-12-14 00:04:33.090757583 +0900
@@ -6,11 +6,16 @@
...
+ii  bsdmainutils             9.0.6             amd64             collection of more utilities from FreeBSD
 ii  bsdutils                 1:2.25.2-4        amd64             basic utilities from 4.4BSD-Lite
...
+ii  libapt-inst1.5:amd64     1.0.9.4           amd64             deb package format runtime library
 ...
 ii  libblkid1:amd64          2.25.2-4          amd64             block device id library
...
@@ -84,27 +133,56 @@
 ...
 ii  libuuid1:amd64           2.25.2-4          amd64             Universally Unique ID library
