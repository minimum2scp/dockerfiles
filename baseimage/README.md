...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150713-24490-su8eof.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150713-24490-1xpesi0.out
% diff -u /tmp/docker-diff.20150713-24490-su8eof.out /tmp/docker-diff.20150713-24490-1xpesi0.out
--- /tmp/docker-diff.20150713-24490-su8eof.out	2015-07-13 00:32:52.839732757 +0900
+++ /tmp/docker-diff.20150713-24490-1xpesi0.out	2015-07-13 00:32:54.355736880 +0900
@@ -8,8 +8,12 @@
