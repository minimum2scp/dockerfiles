...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150322-13273-d1p6ax.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150322-13273-u8rzes.out
% diff -u /tmp/docker-diff.20150322-13273-d1p6ax.out /tmp/docker-diff.20150322-13273-u8rzes.out
--- /tmp/docker-diff.20150322-13273-d1p6ax.out	2015-03-22 04:59:50.339803602 +0900
+++ /tmp/docker-diff.20150322-13273-u8rzes.out	2015-03-22 04:59:50.923797873 +0900
@@ -9,8 +9,12 @@
...
+ii  libssl1.0.0:amd64        1.0.1k-2          amd64             Secure Sockets Layer toolkit - shared libraries
...
+ii  openssl                  1.0.1k-2          amd64             Secure Sockets Layer toolkit - cryptographic utility
...
+ii  vim-tiny                 2:7.4.488-5       amd64             Vi IMproved - enhanced vi editor - compact version
