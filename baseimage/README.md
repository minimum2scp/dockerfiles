...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151003-24328-b5cnr4.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151003-24328-g6nhmu.out
% diff -u /tmp/docker-diff.20151003-24328-b5cnr4.out /tmp/docker-diff.20151003-24328-g6nhmu.out
--- /tmp/docker-diff.20151003-24328-b5cnr4.out	2015-10-03 00:15:50.116608346 +0900
+++ /tmp/docker-diff.20151003-24328-g6nhmu.out	2015-10-03 00:15:51.424660935 +0900
@@ -8,8 +8,12 @@
