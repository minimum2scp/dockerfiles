...
ii   curl                         8.8.0-4                         amd64  command line tool for transferring data with URL syntax
...
ii   libc-l10n                    2.39-5                          all    GNU C Library: localization files
...
ii   libcurl3t64-gnutls           8.8.0-4                         amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii   locales                      2.39-5                          all    GNU C Library: National Language (locale) data [support]
...
ii   systemd-standalone-sysusers  256.2-1                         amd64  standalone sysusers binary for use in non-systemd systems
