...
ii   gcc-14-base                  14.2.0-5                        amd64  GCC, the GNU Compiler Collection (base package)
...
ii   libblkid1                    2.40.2-8                        amd64  block device ID library
...
ii   libmount1                    2.40.2-8                        amd64  device mounting library
...
ii   libnsl2                      1.3.0-3+b2                      amd64  Public client interface for NIS(YP) and NIS+
...
ii   libsmartcols1                2.40.2-8                        amd64  smart column output alignment library
...
ii   libstdc++6                   14.2.0-5                        amd64  GNU Standard C++ Library v3
ii   libsystemd0                  256.6-1                         amd64  systemd utility library
...
ii   libtirpc3t64                 1.3.4+ds-1.3                    amd64  transport-independent RPC library
ii   libuchardet0                 0.0.8-1+b1                      amd64  universal charset detection library - shared library
ii   libudev1                     256.6-1                         amd64  libudev shared library
ii   libunistring5                1.2-1                           amd64  Unicode string library for C
ii   libuuid1                     2.40.2-8                        amd64  Universally Unique ID library
...
ii   systemd-standalone-sysusers  256.6-1                         amd64  standalone sysusers binary for use in non-systemd systems
ii   sysv-rc                      3.10-2                          all    System-V-like runlevel change mechanism
ii   sysvinit-core                3.10-2                          amd64  System-V-like init
...
ii   util-linux                   2.40.2-8                        amd64  miscellaneous system utilities
ii   vim-common                   2:9.1.0709-2                    all    Vi IMproved - Common files
ii   vim-tiny                     2:9.1.0709-2                    amd64  Vi IMproved - enhanced vi editor - compact version
