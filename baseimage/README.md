...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151012-26480-tbdkl8.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151012-26480-1ien9qg.out
% diff -u /tmp/docker-diff.20151012-26480-tbdkl8.out /tmp/docker-diff.20151012-26480-1ien9qg.out
--- /tmp/docker-diff.20151012-26480-tbdkl8.out	2015-10-12 00:21:24.072781325 +0900
+++ /tmp/docker-diff.20151012-26480-1ien9qg.out	2015-10-12 00:21:25.596749557 +0900
@@ -8,8 +8,12 @@
...
-ii  systemd                         227-2                amd64                system and service manager
