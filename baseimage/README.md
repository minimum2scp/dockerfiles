...
ii   apt                          2.9.1                           amd64  commandline package manager
...
ii   bsdextrautils                2.40-6                          amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.40-6                        amd64  basic utilities from 4.4BSD-Lite
...
ii   curl                         8.7.1-2                         amd64  command line tool for transferring data with URL syntax
...
ii   libapt-pkg6.0t64             2.9.1                           amd64  package management runtime library
...
ii   libblkid1                    2.40-6                          amd64  block device ID library
...
ii   libc-bin                     2.37-17                         amd64  GNU C Library: Binaries
ii   libc-l10n                    2.37-17                         all    GNU C Library: localization files
ii   libc6                        2.37-17                         amd64  GNU C Library: Shared libraries
...
ii   libcurl3t64-gnutls           8.7.1-2                         amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4t64                  8.7.1-2                         amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   libmount1                    2.40-6                          amd64  device mounting library
...
ii   libsmartcols1                2.40-6                          amd64  smart column output alignment library
...
ii   libuuid1                     2.40-6                          amd64  Universally Unique ID library
...
ii   locales                      2.37-17                         all    GNU C Library: National Language (locale) data [support]
...
ii   mount                        2.40-6                          amd64  tools for mounting and manipulating filesystems
...
ii   util-linux                   2.40-6                          amd64  miscellaneous system utilities
