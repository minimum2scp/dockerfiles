...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151207-15744-1umm51g.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151207-15744-1onyu9w.out
% diff -u /tmp/docker-diff.20151207-15744-1umm51g.out /tmp/docker-diff.20151207-15744-1onyu9w.out
--- /tmp/docker-diff.20151207-15744-1umm51g.out	2015-12-07 00:13:10.038713129 +0900
+++ /tmp/docker-diff.20151207-15744-1onyu9w.out	2015-12-07 00:13:11.674712380 +0900
@@ -8,8 +8,12 @@
...
+ii  etckeeper                       1.18.1               all                  store /etc in git, mercurial, bzr or darcs
 ...
 ii  gcc-5-base:amd64                5.3.1-1              amd64                GCC, the GNU Compiler Collection (base package)
...
+ii  libffi6:amd64                   3.2.1-3              amd64                Foreign Function Interface library runtime
 ii  libgcc1:amd64                   1:5.3.1-1            amd64                GCC support library
...
+ii  libssl1.0.2:amd64               1.0.2e-1             amd64                Secure Sockets Layer toolkit - shared libraries
 ii  libstdc++6:amd64                5.3.1-1              amd64                GNU Standard C++ Library v3
