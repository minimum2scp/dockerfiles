...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151004-23222-1gk95ew.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20151004-23222-fspol2.out
% diff -u /tmp/docker-diff.20151004-23222-1gk95ew.out /tmp/docker-diff.20151004-23222-fspol2.out
--- /tmp/docker-diff.20151004-23222-1gk95ew.out	2015-10-04 01:50:12.763979877 +0900
+++ /tmp/docker-diff.20151004-23222-fspol2.out	2015-10-04 01:50:13.955985466 +0900
@@ -8,8 +8,12 @@
...
+ii  etckeeper                1.18.1            all               store /etc in git, mercurial, bzr or darcs
 ...
 ii  gcc-5-base:amd64         5.2.1-20          amd64             GCC, the GNU Compiler Collection (base package)
...
+ii  libffi6:amd64            3.2.1-3           amd64             Foreign Function Interface library runtime
 ii  libgcc1:amd64            1:5.2.1-20        amd64             GCC support library
...
+ii  libssl1.0.0:amd64        1.0.2d-1          amd64             Secure Sockets Layer toolkit - shared libraries
 ii  libstdc++6:amd64         5.2.1-20          amd64             GNU Standard C++ Library v3
 ii  libsystemd0:amd64        226-4             amd64             systemd utility library
...
-ii  systemd                  226-4             amd64             system and service manager
-ii  systemd-sysv             226-4             amd64             system and service manager - SysV links
