...
ii   bsdmainutils            9.0.9                         amd64  collection of more utilities from FreeBSD                                      
...
ii   libc-bin                2.22-5                        amd64  GNU C Library: Binaries                                                        
ii   libc-l10n               2.22-5                        all    GNU C Library: localization files                                              
ii   libc6                   2.22-5                        amd64  GNU C Library: Shared libraries                                                
...
ii   libpython2.7-minimal    2.7.11-6                      amd64  Minimal subset of the Python language (version 2.7)                            
...
ii   locales                 2.22-5                        all    GNU C Library: National Language (locale) data [support]                       
...
ii   multiarch-support       2.22-5                        amd64  Transitional package to ensure multiarch compatibility                         
...
ii   python2.7               2.7.11-6                      amd64  Interactive high-level object-oriented language (version 2.7)                  
ii   python2.7-minimal       2.7.11-6                      amd64  Minimal subset of the Python language (version 2.7)                            
