...
ii   bash                     5.1-6+b1                           amd64  GNU Bourne Again SHell
ii   bsdextrautils            2.38-4                             amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                 1:2.38-4                           amd64  basic utilities from 4.4BSD-Lite
...
ii   libapt-pkg6.0            2.4.5                              amd64  package management runtime library
...
ii   libblkid1                2.38-4                             amd64  block device ID library
...
ii   libcurl3-gnutls          7.83.0-1                           amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4                 7.83.0-1                           amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   libfido2-1               1.11.0-1                           amd64  library for generating and verifying FIDO 2.0 objects
ii   libgcc-s1                12.1.0-1                           amd64  GCC support library
...
ii   libstdc++6               12.1.0-1                           amd64  GNU Standard C++ Library v3
...
ii   openssl                  1.1.1o-1                           amd64  Secure Sockets Layer toolkit - cryptographic utility
...
ii   sysvinit-core            3.03-1                             amd64  System-V-like init
...
ii   util-linux               2.38-4                             amd64  miscellaneous system utilities
ii   util-linux-extra         2.38-4                             amd64  interactive login tools
...
ii   xxd                      2:8.2.4793-1                       amd64  tool to make (or reverse) a hex dump
ii   zlib1g                   1:1.2.11.dfsg-4                    amd64  compression library - runtime
ii   zsh                      5.8.1-1+b1                         amd64  shell with lots of features
