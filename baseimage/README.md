...
ii   apt                     2.1.7                           amd64  commandline package manager
...
ii   bsdextrautils           2.35.2-9                        amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                1:2.35.2-9                      amd64  basic utilities from 4.4BSD-Lite
...
ii   gcc-10-base             10.1.0-6                        amd64  GCC, the GNU Compiler Collection (base package)
ii   gcc-9-base              9.3.0-16                        amd64  GCC, the GNU Compiler Collection (base package)
ii   git                     1:2.28.0~rc2-1                  amd64  fast, scalable, distributed revision control system
ii   git-man                 1:2.28.0~rc2-1                  all    fast, scalable, distributed revision control system (manual pages)
...
ii   libapt-pkg6.0           2.1.7                           amd64  package management runtime library
...
ii   libblkid1               2.35.2-9                        amd64  block device ID library
...
ii   libgcc-s1               10.1.0-6                        amd64  GCC support library
...
ii   libldap-2.4-2           2.4.50+dfsg-1+b1                amd64  OpenLDAP libraries
...
ii   libmount1               2.35.2-9                        amd64  device mounting library
...
ii   libpython3.8-minimal    3.8.5-1                         amd64  Minimal subset of the Python language (version 3.8)
ii   libpython3.8-stdlib     3.8.5-1                         amd64  Interactive high-level object-oriented language (standard library, version 3.8)
...
ii   libsmartcols1           2.35.2-9                        amd64  smart column output alignment library
ii   libsqlite3-0            3.32.3-1                        amd64  SQLite 3 shared library
...
ii   libstdc++6              10.1.0-6                        amd64  GNU Standard C++ Library v3
...
ii   libuuid1                2.35.2-9                        amd64  Universally Unique ID library
...
ii   mount                   2.35.2-9                        amd64  tools for mounting and manipulating filesystems
...
ii   python3.8               3.8.5-1                         amd64  Interactive high-level object-oriented language (version 3.8)
ii   python3.8-minimal       3.8.5-1                         amd64  Minimal subset of the Python language (version 3.8)
...
ii   util-linux              2.35.2-9                        amd64  miscellaneous system utilities
