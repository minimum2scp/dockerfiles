...
ii   gcc-7-base              7.1.0-11                        amd64  GCC, the GNU Compiler Collection (base package)
...
ii   libc-bin                2.24-13                         amd64  GNU C Library: Binaries
ii   libc-l10n               2.24-13                         all    GNU C Library: localization files
ii   libc6                   2.24-13                         amd64  GNU C Library: Shared libraries
...
ii   libgcc1                 1:7.1.0-11                      amd64  GCC support library
...
ii   libstdc++6              7.1.0-11                        amd64  GNU Standard C++ Library v3
...
ii   locales                 2.24-13                         all    GNU C Library: National Language (locale) data [support]
...
ii   multiarch-support       2.24-13                         amd64  Transitional package to ensure multiarch compatibility
...
ii   python2.7               2.7.13-4                        amd64  Interactive high-level object-oriented language (version 2.7)
ii   python2.7-minimal       2.7.13-4                        amd64  Minimal subset of the Python language (version 2.7)
