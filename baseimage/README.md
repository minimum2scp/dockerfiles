...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150607-25532-uriou0.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150607-25532-ecmb50.out
% diff -u /tmp/docker-diff.20150607-25532-uriou0.out /tmp/docker-diff.20150607-25532-ecmb50.out
--- /tmp/docker-diff.20150607-25532-uriou0.out	2015-06-07 01:54:23.122684078 +0900
+++ /tmp/docker-diff.20150607-25532-ecmb50.out	2015-06-07 01:54:24.466670710 +0900
@@ -8,8 +8,12 @@
