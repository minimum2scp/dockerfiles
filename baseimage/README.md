...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141212-17971-mg9644.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20141212-17971-trz0w8.out
% diff -u /tmp/docker-diff.20141212-17971-mg9644.out /tmp/docker-diff.20141212-17971-trz0w8.out
--- /tmp/docker-diff.20141212-17971-mg9644.out	2014-12-12 21:47:41.436490034 +0900
+++ /tmp/docker-diff.20141212-17971-trz0w8.out	2014-12-12 21:47:42.060485290 +0900
@@ -6,11 +6,16 @@
