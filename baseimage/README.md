...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150527-29890-17kgpn6.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150527-29890-vqowj3.out
% diff -u /tmp/docker-diff.20150527-29890-17kgpn6.out /tmp/docker-diff.20150527-29890-vqowj3.out
--- /tmp/docker-diff.20150527-29890-17kgpn6.out	2015-05-27 00:06:38.132962645 +0900
+++ /tmp/docker-diff.20150527-29890-vqowj3.out	2015-05-27 00:06:39.468967337 +0900
@@ -9,8 +9,12 @@
