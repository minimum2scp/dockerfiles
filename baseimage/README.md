...
+ii  bsdmainutils             9.0.5             amd64             collection of more utilities from FreeBSD
 ii  bsdutils                 1:2.25.1-3        amd64             basic utilities from 4.4BSD-Lite
...
@@ -21,26 +26,33 @@
 ii  dpkg                     1.17.16           amd64             Debian package management system
...
+ii  etckeeper                1.14              all               store /etc in git, mercurial, bzr or darcs
 ...
 ii  gcc-4.8-base:amd64       4.8.3-12          amd64             GCC, the GNU Compiler Collection (base package)
...
+ii  libapt-inst1.5:amd64     1.0.9.2           amd64             deb package format runtime library
 ii  libapt-pkg4.12:amd64     1.0.9.2           amd64             package management runtime library
 ...
 ii  libblkid1:amd64          2.25.1-3          amd64             block device id library
...
+ii  liblognorm1:amd64        1.0.1-3           amd64             Log normalizing library
 ...
 ii  libmount1:amd64          2.25.1-3          amd64             device mounting library
...
+ii  libpython2.7-minimal:amd 2.7.8-10          amd64             Minimal subset of the Python language (version 2.7)
+ii  libpython2.7-stdlib:amd6 2.7.8-10          amd64             Interactive high-level object-oriented language (stan
...
+ii  libsasl2-modules-db:amd6 2.1.26.dfsg1-11   amd64             Cyrus SASL - pluggable authentication modules (DB)
 ...
 ii  libsmartcols1:amd64      2.25.1-3          amd64             smart column output alignment library
...
@@ -84,27 +135,55 @@
 ...
 ii  libuuid1:amd64           2.25.1-3          amd64             Universally Unique ID library
...
+ii  man-db                   2.7.0.2-1         amd64             on-line manual pager
 ii  mawk                     1.3.3-17          amd64             a pattern scanning and text processing language
+ii  mime-support             3.57              all               MIME files 'mime.types' & 'mailcap', and support prog
 ii  mount                    2.25.1-3          amd64             Tools for mounting and manipulating filesystems
...
+ii  python2.7                2.7.8-10          amd64             Interactive high-level object-oriented language (vers
...
+ii  sysvinit-core            2.88dsf-53.4      amd64             System-V-like init utilities
 ...
 ii  util-linux               2.25.1-3          amd64             Miscellaneous system utilities
