...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151014-24704-14tleg3.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=150; dpkg -l' > /tmp/docker-diff.20151014-24704-2lhp2s.out
% diff -u /tmp/docker-diff.20151014-24704-14tleg3.out /tmp/docker-diff.20151014-24704-2lhp2s.out
--- /tmp/docker-diff.20151014-24704-14tleg3.out	2015-10-14 00:11:16.849140136 +0900
+++ /tmp/docker-diff.20151014-24704-2lhp2s.out	2015-10-14 00:11:18.493157413 +0900
@@ -8,8 +8,12 @@
...
+ii  libgcc1:amd64                   1:5.2.1-22           amd64                GCC support library
...
+ii  libp11-kit0:amd64               0.23.1-3             amd64                Library for loading and coordinating access to PKCS#11 modules - run
 ...
 ii  libpcre3:amd64                  2:8.35-7.2           amd64                Perl 5 Compatible Regular Expression Library - runtime files
...
+ii  libstdc++6:amd64                5.2.1-22             amd64                GNU Standard C++ Library v3
...
+ii  libtasn1-6:amd64                4.7-2                amd64                Manage ASN.1 structures (runtime)
 ...
 ii  libtinfo5:amd64                 6.0+20150810-1       amd64                shared low-level terminfo library for terminal handling
-ii  libudev1:amd64                  226-4                amd64                libudev shared library
...
+ii  locales                         2.19-22              all                  GNU C Library: National Language (locale) data [support]
