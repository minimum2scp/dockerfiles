...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150916-24396-ytvqp7.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150916-24396-1wim108.out
% diff -u /tmp/docker-diff.20150916-24396-ytvqp7.out /tmp/docker-diff.20150916-24396-1wim108.out
--- /tmp/docker-diff.20150916-24396-ytvqp7.out	2015-09-16 00:05:25.130870317 +0900
+++ /tmp/docker-diff.20150916-24396-1wim108.out	2015-09-16 00:05:26.640314467 +0900
@@ -8,8 +8,12 @@
...
+ii  bsdmainutils             9.0.6             amd64             collection of more utilities from FreeBSD
 ii  bsdutils                 1:2.27-1          amd64             basic utilities from 4.4BSD-Lite
...
+ii  etckeeper                1.18.1            all               store /etc in git, mercurial, bzr or darcs
 ...
 ii  gcc-5-base:amd64         5.2.1-17          amd64             GCC, the GNU Compiler Collection (base package)
...
+ii  libbsd0:amd64            0.7.0-2           amd64             utility functions from BSD systems - shared library
 ...
 ii  libc-bin                 2.19-20           amd64             GNU C Library: Binaries
 ii  libc6:amd64              2.19-20           amd64             GNU C Library: Shared libraries
@@ -48,35 +58,68 @@
...
+ii  libexpat1:amd64          2.1.0-7           amd64             XML parsing C library - runtime library
 ii  libfdisk1:amd64          2.27-1            amd64             fdisk partitioning library
+ii  libffi6:amd64            3.2.1-3           amd64             Foreign Function Interface library runtime
 ii  libgcc1:amd64            1:5.2.1-17        amd64             GCC support library
...
+ii  libgnutls-deb0-28:amd64  3.3.17-1          amd64             GNU TLS library - main runtime library
...
+ii  libidn11:amd64           1.32-1            amd64             GNU Libidn library, implementation of IETF IDN specif
...
+ii  libkeyutils1:amd64       1.5.9-7           amd64             Linux Key Management Utilities (library)
...
+ii  liblognorm2:amd64        1.1.1-1           amd64             Log normalizing library
 ...
 ii  libmount1:amd64          2.27-1            amd64             device mounting library
...
+ii  libp11-kit0:amd64        0.23.1-3          amd64             Library for loading and coordinating access to PKCS#1
 ...
 ii  libpcre3:amd64           2:8.35-7.2        amd64             Perl 5 Compatible Regular Expression Library - runtim
...
+ii  libslang2:amd64          2.3.0-2+b1        amd64             S-Lang programming library - runtime version
 ii  libsmartcols1:amd64      2.27-1            amd64             smart column output alignment library
...
+ii  libssl1.0.0:amd64        1.0.2d-1          amd64             Secure Sockets Layer toolkit - shared libraries
 ...
 ii  libsystemd0:amd64        226-1             amd64             systemd utility library
...
+ii  locales                  2.19-20           all               GNU C Library: National Language (locale) data [suppo
 ii  login                    1:4.2-3           amd64             system login tools
 ii  lsb-base                 9.20150826        all               Linux Standard Base init script functionality
+ii  lv                       4.51-2.3          amd64             Powerful Multilingual File Viewer
+ii  man-db                   2.7.3-1           amd64             on-line manual pager
 ii  mawk                     1.3.3-17          amd64             a pattern scanning and text processing language
 ii  mount                    2.27-1            amd64             Tools for mounting and manipulating filesystems
 ii  multiarch-support        2.19-20           amd64             Transitional package to ensure multiarch compatibilit
...
+ii  openssh-client           1:6.9p1-2         amd64             secure shell (SSH) client, for secure access to remot
+ii  openssh-server           1:6.9p1-2         amd64             secure shell (SSH) server, for secure access from rem
+ii  openssh-sftp-server      1:6.9p1-2         amd64             secure shell (SSH) sftp server module, for SFTP acces
...
-ii  systemd                  226-1             amd64             system and service manager
-ii  systemd-sysv             226-1             amd64             system and service manager - SysV links
...
+ii  ucf                      3.0030            all               Update Configuration File(s): preserve user changes t
 ii  udev                     226-1             amd64             /dev/ and hotplug management daemon
 ii  util-linux               2.27-1            amd64             Miscellaneous system utilities
