...
ii   libc-bin                 2.37-3                          amd64  GNU C Library: Binaries
ii   libc-l10n                2.37-3                          all    GNU C Library: localization files
ii   libc6                    2.37-3                          amd64  GNU C Library: Shared libraries
...
ii   locales                  2.37-3                          all    GNU C Library: National Language (locale) data [support]
