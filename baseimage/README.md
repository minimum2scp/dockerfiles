...
ii   bsdextrautils           2.37.2-2                        amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                1:2.37.2-2                      amd64  basic utilities from 4.4BSD-Lite
...
ii   libc-bin                2.32-3                          amd64  GNU C Library: Binaries
ii   libc-l10n               2.32-3                          all    GNU C Library: localization files
ii   libc6                   2.32-3                          amd64  GNU C Library: Shared libraries
...
ii   libexpat1               2.4.1-2                         amd64  XML parsing C library - runtime library
...
ii   libmount1               2.37.2-2                        amd64  device mounting library
...
ii   libuuid1                2.37.2-2                        amd64  Universally Unique ID library
...
ii   locales                 2.32-3                          all    GNU C Library: National Language (locale) data [support]
...
ii   zsh                     5.8-9                           amd64  shell with lots of features
ii   zsh-common              5.8-9                           all    architecture independent files for Zsh
