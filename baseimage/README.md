...
ii   bsdextrautils                2.40-7                          amd64  extra utilities from 4.4BSD-Lite
ii   bsdutils                     1:2.40-7                        amd64  basic utilities from 4.4BSD-Lite
...
ii   curl                         8.7.1-3                         amd64  command line tool for transferring data with URL syntax
...
ii   libblkid1                    2.40-7                          amd64  block device ID library
...
ii   libc-bin                     2.37-18                         amd64  GNU C Library: Binaries
ii   libc-l10n                    2.37-18                         all    GNU C Library: localization files
ii   libc6                        2.37-18                         amd64  GNU C Library: Shared libraries
...
ii   libcom-err2                  1.47.0-2.4                      amd64  common error description library
ii   libcrypt1                    1:4.4.36-4                      amd64  libcrypt shared library
ii   libcurl3t64-gnutls           8.7.1-3                         amd64  easy-to-use client-side URL transfer library (GnuTLS flavour)
ii   libcurl4t64                  8.7.1-3                         amd64  easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii   libmount1                    2.40-7                          amd64  device mounting library
...
ii   libperl5.38t64               5.38.2-3.2+b2                   amd64  shared Perl library
...
ii   libsmartcols1                2.40-7                          amd64  smart column output alignment library
...
ii   libuuid1                     2.40-7                          amd64  Universally Unique ID library
...
ii   locales                      2.37-18                         all    GNU C Library: National Language (locale) data [support]
...
ii   mount                        2.40-7                          amd64  tools for mounting and manipulating filesystems
...
ii   perl                         5.38.2-3.2+b2                   amd64  Larry Wall's Practical Extraction and Report Language
ii   perl-base                    5.38.2-3.2+b2                   amd64  minimal Perl system
...
ii   util-linux                   2.40-7                          amd64  miscellaneous system utilities
ii   vim-common                   2:9.1.0199-1                    all    Vi IMproved - Common files
ii   vim-tiny                     2:9.1.0199-1+b1                 amd64  Vi IMproved - enhanced vi editor - compact version
