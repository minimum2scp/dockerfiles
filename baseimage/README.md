...
```
% docker run --rm minimum2scp/debian:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150114-23246-pnjx7c.out
% docker run --rm minimum2scp/baseimage:latest bash -c 'export LANG=C; export COLUMNS=120; dpkg -l' > /tmp/docker-diff.20150114-23246-tk8h65.out
% diff -u /tmp/docker-diff.20150114-23246-pnjx7c.out /tmp/docker-diff.20150114-23246-tk8h65.out
--- /tmp/docker-diff.20150114-23246-pnjx7c.out	2015-01-14 00:21:33.788964469 +0900
+++ /tmp/docker-diff.20150114-23246-tk8h65.out	2015-01-14 00:21:34.404959697 +0900
@@ -6,11 +6,16 @@
